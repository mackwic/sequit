<script lang="ts">
	...
	import { createWebSocketCollaborationTransport } from '$lib/collaboration/websocket-collaboration-transport';
	...
	} from '$lib/document/collaborative-document-session';
	import {
		type DocumentCommandOutcome,
		DocumentCommandOutcomeKind,
	} from '$lib/document/document-command-gateway';
