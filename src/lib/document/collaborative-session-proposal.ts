...
import { CollabMessageKind, encodeCollabMessage, ProposalIntent } from '../collaboration/protocol';
import { replaceNodeMarkdown } from '../collaboration/yjs-document-repository';
