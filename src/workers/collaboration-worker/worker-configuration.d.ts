/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/workers/collaboration-worker/wrangler.jsonc src/workers/collaboration-worker/worker-configuration.d.ts` (hash: 24ceb15a0af102e7f4c23f5f8263b354)
// Runtime types generated with workerd@1.20260903.1 2026-07-21 
interface __BaseEnv_Env {
	COLLABORATION_ROOMS: DurableObjectNamespace<import("./index").CollaborationRoom>;
}
