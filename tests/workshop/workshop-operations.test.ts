...
import { EndpointKind, JunctionOperator } from '../../src/lib/document/logic-document';
...
import {
	...
	groupWorkshopNodes,
} from '../../src/routes/atelier/runtime/workshop-group-operations';
import {
	addWorkshopNode,
	duplicateWorkshopNodes,
	placeWorkshopNodeFirst,
	removeWorkshopNodes,
} from '../../src/routes/atelier/runtime/workshop-node-operations';
