...
import { CollabMessageKind, ProposalIntent } from '../../src/lib/collaboration/protocol';
import {
	GateDecisionKind,
...
import { CHUNK_BYTES, MAX_CHUNKS } from '../../src/lib/collaboration/room-persistence';
import { collaborativeDocument } from '../builders/collaboration';
